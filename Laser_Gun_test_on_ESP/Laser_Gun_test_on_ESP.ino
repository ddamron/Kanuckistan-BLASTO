...
// Digital IO's
int triggerPin             = 0;      // Push button for primary fire. Low = pressed
int trigger2Pin            = 2;     // Push button for secondary fire. Low = pressed
...
int IRtransmitPin          = 13;      // Primary fire mode IR transmitter pin: Use pins 2,4,7,8,12 or 13. DO NOT USE PWM pins!! More info: http://j44industries.blogspot.com/2009/09/arduino-frequency-generation.html#more
...
int automatic2             = 0;      // Defined by gameType and configureGame subroutine. Secondary fire auto?
